import { a as isAvailable, i as fetchProducts, o as formatZAR } from "./products-BefVLJjO.js";
...
function Storefront() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-background/70 via-background/40 to-background" }),
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-background/80 via-transparent to-background/60" })
					]
				}), /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("a", {
							...
							children: ["Explore the collection", /* @__PURE__ */ jsx("span", {
								"aria-hidden": true,
								children: "→"
							})]
						})
			...
			category === "All" && preorderCount > 0 && /* @__PURE__ */ jsx("section", {
				id: "preorder",
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: all.filter((p) => p.preorder).slice(0, 3).map((p) => /* @__PURE__ */ jsx(ProductCard, { product: p }, p.id))
					})]
				})
			}),
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
					...
					isLoading && /* @__PURE__ */ jsx("div", {
						...
						children: Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("div", { className: "aspect-[4/5] rounded-lg bg-muted" }),
								/* @__PURE__ */ jsx("div", { className: "mt-4 h-4 w-3/4 rounded bg-muted" }),
								/* @__PURE__ */ jsx("div", { className: "mt-2 h-4 w-1/3 rounded bg-muted" })
							]
						}, i))
					}),
					...
					!isLoading && !error && products.length === 0 && /* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [
			/* @__PURE__ */ jsxs(Link, {
				...
				children: [
					product.signed_image_url ? /* @__PURE__ */ jsx("img", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						}), product.preorder && /* @__PURE__ */ jsx("span", {
					...
					product.preorder ? /* @__PURE__ */ jsx("div", {
					...
					}) : !product.in_stock && /* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 transition duration-500 group-hover:opacity-100" })
				]
			}),
			/* @__PURE__ */ jsxs("div", {
