import { a as getServerFnById, i as TSS_SERVER_FUNCTION, r as createServerFn } from "./server-0Tno1-Yx.js";
import { t as requireSupabaseAuth } from "./auth-middleware-DCQYv7tD.js";
import { i as fetchProducts, n as PREORDER_WINDOWS, o as formatZAR, t as CATEGORIES } from "./products-BefVLJjO.js";
...
import { AlertTriangle, Boxes, Check, Coins, LayoutDashboard, Loader2, LogOut, Minus, Package, Pencil, Plus, Receipt, ShieldCheck, Sparkles, Trash2, TrendingUp, Truck, X } from "lucide-react";
...
//#endregion
//#region src/components/admin/dashboard-panel.tsx
function DashboardPanel({ products, orders }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			(stats.lowStock.length > 0 || stats.outOfStock.length > 0) && /* @__PURE__ */ jsxs("div", {
				className: "rounded border border-border bg-card p-4",
				children: [/* @__PURE__ */ jsxs("p", {
					className: "flex items-center gap-2 text-xs uppercase tracking-widest text-primary",
					children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-4 w-4" }), " Needs restocking"]
				}), /* @__PURE__ */ jsx("ul", {
					className: "mt-3 space-y-2 text-sm",
					children: [...stats.outOfStock, ...stats.lowStock].map((p) => /* @__PURE__ */ jsxs("li", {
...
//#endregion
//#region src/lib/enhance-image.ts
var MAX_DIM = 1600;
...
//#endregion
//#region src/components/admin/image-enhancer.tsx
var PRESETS = [
	{
		id: "studio",
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
						...
						children: result ? /* @__PURE__ */ jsx("img", {
							src: result,
							alt: "Enhanced",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }), busy ? "Enhancing…" : result ? "Re-run" : "Enhance"]
						}),
						/* @__PURE__ */ jsx("button", {
							type: "button",
							onClick: () => void accept(),
...
//#endregion
//#region src/components/admin/product-form.tsx
...
function ProductForm({ product, onClose, onSaved }) {
	...
	const [preorderEta, setPreorderEta] = useState(product?.preorder_eta ?? PREORDER_WINDOWS[1]);
	const [category, setCategory] = useState(product?.category ?? "925 Silver");
	...
	return /* @__PURE__ */ jsxs("div", {
					...
					children: [
							...
							children: [/* @__PURE__ */ jsxs("label", {
								...
								children: /* @__PURE__ */ jsx(Field, {
									...
									children: /* @__PURE__ */ jsx("select", {
										...
										children: PREORDER_WINDOWS.map((w) => /* @__PURE__ */ jsx("option", {
											value: w,
											children: w
										}, w))
									})
							...
							children: [
								...
								file && /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("img", {
										...
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }), " Enhance with AI"]
									})]
								}),
								product?.signed_image_url && !file && /* @__PURE__ */ jsx("img", {
						...
						/* @__PURE__ */ jsxs(Field, {
							...
							children: [
								...
								existingGallery.length > 0 && /* @__PURE__ */ jsx("div", {
								...
								galleryFiles.length > 0 && /* @__PURE__ */ jsx("div", {
									className: "mt-2 flex flex-wrap gap-2",
									children: galleryFiles.map((f, idx) => /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("img", {
											...
											children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3 w-3" }), " AI"]
										})]
									}, `${f.name}-${idx}`))
								})
							]
		...
		}), enhancing && enhanceTargetFile && /* @__PURE__ */ jsx(ImageEnhancer, {
...
//#endregion
//#region src/components/admin/products-panel.tsx
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
				...
				children: [/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }), " New product"]
			})]
		}),
		isLoading ? /* @__PURE__ */ jsx("p", {
					...
					children: [
						/* @__PURE__ */ jsx("td", {
							...
							children: /* @__PURE__ */ jsx("div", {
								...
								children: p.signed_image_url && /* @__PURE__ */ jsx("img", {
			...
			}), products.map((p) => /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/components/admin/inventory-panel.tsx
var VIEWS = [
	{
		id: "instock",
		label: "In stock"
...
function InventoryPanel({ products, orders, refetch }) {
	...
	const [view, setView] = useState("instock");
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: VIEWS.map((v) => /* @__PURE__ */ jsxs("button", {
...
//#endregion
//#region src/lib/receipt.functions.ts
var scanReceipt = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((input) => z.object({ dataUrl: z.string().min(32) }).parse(input)).handler(createSsrRpc("e23f739052537814819c58cf9d299e571b86705b2488cbafb60f4c6802d3de9b"));
//#endregion
//#region src/components/admin/purchases-panel.tsx
var STATUSES = [
	"draft",
	"ordered",
	"received"
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
				...
				className: "flex items-center gap-2 rounded bg-gradient-to-r from-primary to-purple-glow px-4 py-2.5 text-xs font-medium uppercase tracking-widest text-primary-foreground",
				children: [/* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }), " New purchase"]
			})]
		}),
		isLoading ? /* @__PURE__ */ jsx("p", {
			className: "text-muted-foreground",
			...
			className: "space-y-3",
			children: orders.map((po) => /* @__PURE__ */ jsxs("div", {
				className: "rounded border border-border bg-card p-4",
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("p", {
							className: "truncate text-sm text-foreground",
							children: [po.supplier || "Unknown supplier", po.reference && /* @__PURE__ */ jsxs("span", {
								className: "text-muted-foreground",
					...
					children: po.items.map((i, idx) => /* @__PURE__ */ jsxs("li", {
						...
						}), /* @__PURE__ */ jsx("span", { children: formatZAR(i.quantity * i.unit_cost) })]
					}, i.id ?? idx))
				})]
			}, po.id))
		}),
		showForm && /* @__PURE__ */ jsx(PurchaseForm, {
			order: editing,
			products,
			onClose: () => setShowForm(false),
			onSaved: () => {
...
function PurchaseForm({ order, products, onClose, onSaved }) {
	...
	const [orderDate, setOrderDate] = useState(order?.order_date ?? (/* @__PURE__ */ new Date()).toISOString().slice(0, 10));
	...
	const [items, setItems] = useState(order?.items.length ? order.items : [emptyItem()]);
	const [preorderIds, setPreorderIds] = useState(products.filter((p) => p.preorder).map((p) => p.id));
	const [preorderEta, setPreorderEta] = useState(products.find((p) => p.preorder && p.preorder_eta)?.preorder_eta ?? PREORDER_WINDOWS[1]);
		...
		children: /* @__PURE__ */ jsxs("form", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("label", {
					...
					children: [
						scanning ? /* @__PURE__ */ jsx(Loader2, { className: "h-5 w-5 animate-spin text-primary" }) : /* @__PURE__ */ jsx(Sparkles, { className: "h-5 w-5 text-primary" }),
						/* @__PURE__ */ jsxs("span", {
							className: "text-sm text-foreground",
							children: [scanning ? "Reading your receipt…" : "Scan a receipt screenshot with AI", /* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: items.map((item, idx) => /* @__PURE__ */ jsxs("div", {
								className: "rounded border border-border/70 p-3",
								children: [
									/* @__PURE__ */ jsxs("div", {
									...
									item.product_id && /* @__PURE__ */ jsxs("label", {
						...
						items.some((i) => i.product_id && preorderIds.includes(i.product_id)) && /* @__PURE__ */ jsx("div", {
						...
						/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5" }), " Add item"]
						})
					]
				}),
				/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("main", {
				...
				}) : tab === "overview" ? /* @__PURE__ */ jsx(DashboardPanel, {
					products,
					orders
				}) : tab === "products" ? /* @__PURE__ */ jsx(ProductsPanel, {
					products,
					isLoading: productsQuery.isLoading,
					refetch: () => void productsQuery.refetch()
				}) : tab === "inventory" ? /* @__PURE__ */ jsx(InventoryPanel, {
					products,
					orders,
					refetch: () => void productsQuery.refetch()
				}) : /* @__PURE__ */ jsx(PurchasesPanel, {
					orders,
					products,
			...
			isAdmin && /* @__PURE__ */ jsx("nav", {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: TABS.map((t) => /* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(t.icon, { className: "h-5 w-5" }), t.label]
					}, t.id))
				})
			})
		]
