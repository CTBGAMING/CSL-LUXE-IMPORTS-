...
import { _getRenderedMatches, createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isDangerousProtocol, isNotFound, isRedirect as isRedirect$1, makeSerovalPlugin, parseRedirect, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId } from "@tanstack/router-core";
import { mergeHeaders, mergeHeaders as mergeHeaders$1 } from "@tanstack/router-core/ssr/client";
import { fromJSON, toCrossJSONAsync, toCrossJSONStream } from "seroval";
import { createMemoryHistory } from "@tanstack/history";
import { attachRouterServerSsrUtils, bindSsrResponseToRequest, disposeSsrResponseDetached, getNormalizedURL, getOrigin, isSsrResponse, normalizeSsrResponse, replaceSsrResponse, stripSsrResponseBody, waitForRequest } from "@tanstack/router-core/ssr/server";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CNw3m7s0.js");
...
var manifest = { "e23f739052537814819c58cf9d299e571b86705b2488cbafb60f4c6802d3de9b": {
	functionName: "scanReceipt_createServerFn_handler",
	importer: () => import("./receipt.functions-CMf3PISo.js")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dfthusd6.js").then((n) => n.t),
		import("./start-NqrpRIFb.js"),
...
//#endregion
export { getServerFnById as a, createServerEntry, server_default as default, TSS_SERVER_FUNCTION as i, createCsrfMiddleware as n, getRequest as o, createServerFn as r, server_exports as t };
