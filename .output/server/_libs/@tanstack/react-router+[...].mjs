...
import { o as require_jsx_runtime } from "../react+tanstack__react-query.mjs";
	...
	constructor(options, getStoreConfig) {
		...
		this.buildLocation = (opts) => {
			const build = (dest = {}) => {
				...
				const nextPathname = opts.leaveParams ? nextTo : decodePath(normalizeProtocolRelative(interpolatePath({
					path: nextTo,
					params: nextParams,
		...
		this.commitLocation = async ({ viewTransition, ignoreBlocker, ...next }) => {
			if ((next.maskedLocation ?? next).external && false);
			let historyAction;
...
async function documentNavigation(router, href, { replace, ignoreBlocker }) {
	if (isDangerousProtocol(href, router.protocolAllowlist)) return;
	if (!ignoreBlocker) {
...
//#endregion
export { executeRewriteInput as A, isNotFound as B, createInlineCssPlaceholderAsset as C, resolveManifestAssetLink as D, getStylesheetHref as E, dehydrateSsrMatchId as F, isRedirect as I, parseRedirect as L, createSieveCache as M, decodePath as N, resolveManifestCssLink as O, isDangerousProtocol as P, redirect as R, TSR_SCRIPT_BARRIER_ID as S, getScriptPreloadAttrs as T, notFound as V, createRootRouteWithContext as _, isSsrResponse as a, useRouter as b, stripSsrResponseBody as c, HeadContent as d, RouterProvider as f, createFileRoute as g, lazyRouteComponent as h, disposeSsrResponseDetached as i, invariant as j, _getRenderedMatches as k, require_react_dom as l, Outlet as m, bindSsrResponseToRequest as n, normalizeSsrResponse as o, createRouter as p, defineHandlerCallback as r, replaceSsrResponse as s, renderRouterToStream as t, Scripts as u, Link as v, createInlineCssStyleAsset as w, GLOBAL_TSR as x, useNavigate as y, rootRouteId as z };
